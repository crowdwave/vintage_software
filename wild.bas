...
0230 REM *                             *
0240 REM *******************************
0250 REM WRITTEN BY PAUL STUART
0260 REM WITH ANDREW STUART
0270 REM
0280 REM DATE:25/4/84
0290 REM
0300 REM VERSION 7
0310 REM
0320 REM
0330 REM
0340 REM*******SPRITE CREATION*********
0350 REM
0430 POKE 53280,0 : POKE 53281,0
0432 POKE 646,11
0440 PRINT CHR*(147)
0442 V=53248
0451 POKE V+21,4 : REM ENABLES SPRITE 2
0453 POKE 2042 ,13 : REM DATA LOCATION
0455 FOR N=0 TO 15:POKE 832+N,O:NEXT N
0457 FOR N=0 TO 30:READ Q:POKE 848+N,Q:NEXT N
0459 FOR N=0 TO 15:POKE 879+N,O:NEXT N
0461 DATA 48,0,0,72,0,0,72,0,0,48,0,0
0462 DATA 252,0,0,48,0,0,48,0,0,48
0463 DATA 0,0,72,0,0,72,0,0,204
0730 REM
0740 DIM W$(12)
0745 DIM DUNJ(22,5)
0750 GOTO 1200
0755 REM
0760 REM ****** DUNGEON GENERATION ******
0765 REM
0766 REM DUNJ(RM YOU ARE IN,0) GIVES ROW
0767 REM NO OF DUNJ WHICH HAS DETAILS OF
0768 REM THAT ROOM
0770 RESTORE
0775 FOR M=1 TO 31 :READ Q:NEXT M
0780 FOR D=1 TO 22
0800 R=INT(RND(1)*22)+1
0820 FOR E=1 TO D
0840 IF DUNJ(E,1)=R THEN 800
0860 NEXT E
0880 DUNJ(D,1)=R :DUNJ(R,0)=D: DUNJ(D,5)=INT()RND(1)*10)+1
0900 NEXT D
0905 CN=INT(RND(1)*22)+1
0930 FOR L =1 TO 22
0940 READ L1,L2,L3
0960 DUNJ(L,2 )=DUNJ(LI,1)
0980 DUNJ(L,3)=DUNJ(L2,1)
...
2070 IF A$="A" THEN PRINT:PRINT"YOU ARE ALONE" : GOTO I960
...
2620 IF A$="X" THEN GOSUB 5510:G0T0 2550
